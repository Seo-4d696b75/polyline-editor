...
const Triangle = {
	 ...
	 */
	getIntersection: function (triangle, line) {
	...
	getOppositeSide: function (triangle, point) {
	...
	containsPoint: function (triangle, point, error) {
